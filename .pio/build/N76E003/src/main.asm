...
;------------------------------------------------------------
;	src\main.c:12: void Timer0_ISR(void) __interrupt (1)
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	mov	psw,#0x00
;	src\main.c:15: if (timerIsp && --timerIsp == 0) timerIspOver = TRUE;
	mov	a,_timerIsp
	orl	a,(_timerIsp + 1)
	jz	00102$
	mov	a,_timerIsp
...
;	assignBit
	setb	_timerIspOver
00102$:
;	src\main.c:16: if (timerUart && --timerUart == 0) timerUartOver = TRUE;
	mov	a,_timerUart
	jz	00107$
	mov	a,_timerUart
	dec	a
...
;------------------------------------------------------------
;	src\main.c:25: void UART_ISR(void) __interrupt (UART_ISR_NUMBER)
;	-----------------------------------------
;	 function UART1_ISR
;	-----------------------------------------
_UART1_ISR:
	...
	push	psw
	mov	psw,#0x00
;	src\main.c:28: UART_INTERRUPT_RX_FLAG = 0;
;	assignBit
	clr	_RI_1
;	src\main.c:29: uartBuf[indexRx++] = UART_SBUF;
	mov	a,_indexRx
	mov	r7,a
	inc	a
	mov	_indexRx,a
	...
	mov	r0,a
	mov	@r0,_SBUF_1
;	src\main.c:30: if (indexRx == 1){
	mov	a,#0x01
	cjne	a,_indexRx,00104$
;	src\main.c:31: timerUart = UART_TIMOUT;
	mov	_timerUart,#0x05
;	src\main.c:32: timerUartOver = FALSE;
;	assignBit
	clr	_timerUartOver
	sjmp	00106$
00104$:
;	src\main.c:34: else if (indexRx == PACK_SIZE) DISABLE_GLOBAL_INTERRUPT;
	mov	a,#0x40
	cjne	a,_indexRx,00106$
;	assignBit
	clr	_EA
00106$:
;	src\main.c:35: }
...
;hircMap1                  Allocated to registers r7 
;trim                      Allocated to registers r7 
;------------------------------------------------------------
...
;	-----------------------------------------
_main:
;	src\main.c:70: IAPAH = 0x00;
	mov	_IAPAH,#0x00
;	src\main.c:72: IAPAL = HIRC_16_MHz;
	mov	_IAPAL,#0x30
;	src\main.c:73: IAPTRG |= 0x01;
	orl	_IAPTRG,#0x01
;	src\main.c:74: uint8_t hircMap0 = IAPFD;
	mov	r7,_IAPFD
;	src\main.c:76: IAPAL = HIRC_16_MHz+1;
	mov	_IAPAL,#0x31
;	src\main.c:77: IAPTRG |= 0x01;
	orl	_IAPTRG,#0x01
;	src\main.c:78: uint8_t hircMap1 = IAPFD;
	mov	r6,_IAPFD
;	src\main.c:80: uint8_t trim = ((hircMap0 << 1) | (hircMap1 & 1)) - 13;  // 40kHz per 1 bit, 40*13=520 kHz
	mov	a,r7
	add	a,r7
	mov	r7,a
	mov	a,#0x01
	...
	orl	a,r7
	add	a,#0xf3
;	src\main.c:81: hircMap0 = trim >> 1;
	mov	r7,a
	clr	c
	rrc	a
	mov	r6,a
;	src\main.c:82: hircMap1 = trim & 1;
	anl	ar7,#0x01
;	src\main.c:84: TA = 0xAA; TA = 0x55;
	mov	_TA,#0xaa
	mov	_TA,#0x55
;	src\main.c:85: RCTRIM0 = hircMap0;
	mov	_RCTRIM0,r6
;	src\main.c:87: TA = 0xAA; TA = 0x55;
	mov	_TA,#0xaa
	mov	_TA,#0x55
;	src\main.c:88: RCTRIM1 = hircMap1;
	mov	_RCTRIM1,r7
;	src\main.c:112: RH3 = HIBYTE(65536 - 9);  // 255 = 0xFF
	mov	_RH3,#0xff
;	src\main.c:113: RL3 = LOBYTE(65536 - 9);  // 247 = 0xF7
	mov	_RL3,#0xf7
...
;	src\main.c:185: if (temp4bytes.DID_high == 0x67){
	mov	a,#0x67
	cjne	a,(_temp4bytes + 0x0001),00107$
